...
<%@page import="dao.CoordinatorDAO"%>
    ...
    <head>
        ...
        <script type="text/javascript" src="jsscript/manageCoordinators.js"></script>
        ...
        <script>
            function myFunction() {
                ...
                if (id === 'Add')
                    ...
                    showRemoveCoordinator();
                else if (id === 'Update')
                    showUpdateCoordinator();
                else
                    showViewAllCoordinator();
            }
        </script>
    </head>
        ...
        <div class="container">
            <div class="column-wrap">
                ...
                <div class="column-left">
                    ...
                    String id=CoordinatorDAO.getNewId();
                        %>
                            <p class="create">
                                <%
                            out.println(userid);
                            ...
                            <button type="button" class="g-recaptcha" onclick="showAddCoordinator()">Add Coordinator</button><br>
                            <button type="button" class="g-recaptcha" onclick="showRemoveCoordinator()">Remove Coordinator</button><br>
                            <button type="button" class="g-recaptcha" onclick="showUpdateCoordinator()">Update Coordinator</button><br>
                            <button type="button" class="g-recaptcha" onclick="showViewAllCoordinator()">View All Coordinator</button><br>
                ...
                <div class="column-right" style="background-image: url('images/mainImage.jpg'); ">
                    <div class="inner " style="border-radius: 20%;">
                        ...
                        <div id="AddCoordinator" style="width: 100%;border-radius:1%;" class="a_message general_announcements" hidden>
                            <h2 class="a_message_title " style="text-align: center;">Register Coordinator</h2>

                            <form method="post" id="addCoordinator">
                                <div class="create">
                                    <label for="text"> Coordinator Id </label><br>
                                ...
                                <div class="a_message_button " style="text-align: center;padding: 10px;">
                                    <!-- <button type="submit" onclick="addCoordinator()" name="addCoordinator"> -->
                                    <!-- <a type="button" style="text-align: center; ">Register Coordinator</a>                                -->
                                    <button type="button" style="width: 100%;color: aliceblue;background-color:inherit;border: 0cm;" class="g-recaptcha" onclick="addCoordinator()"> Add Coordinator
                                    </button>
                                </div>
                                <!-- unique key -->
                            </form>
                        ...
                        <!-- Remove Coordinator -->
                        <div id="RemoveCoordinator" style="width: 100%;border-radius:1%;" class="a_message general_announcements" hidden>
                            <h2 class="a_message_title " style="text-align: center;"> Remove Coordinator
                            </h2>

                            <form action="" method="post" id="removeCoordinator">
                                <div class="create">
                                    <label for="text"> Coordinator Id </label><br>
                                ...
                                <div class="a_message_button " style="text-align: center;padding: 10px;">
                                    ...
                                    <button type="button" style="width: 100%;color: aliceblue;background-color:inherit;border: 0cm;" class="g-recaptcha" onclick="removeCoordinator()"> Remove Coordinator
                                    </button>
                                </div>
                                <!-- unique key -->
                            </form>
                        ...
                        <!-- Update Coordinator Form -->
                        <div id="UpdateCoordinator" style="width: 100%;border-radius:1%;" class="a_message general_announcements" hidden>
                            <h2 class="a_message_title " style="text-align: center;">Update Coordinator</h2>

                            <form action="" method="post" id="updateCoordinator">
                                <div class="create">
                                    <label for="text"> Coordinator Id </label><br>
                                ...
                                <div class="a_message_button " style="text-align: center;padding: 10px;">
                                    <button type="button" style="width: 100%;color: aliceblue;background-color:inherit;border: 0cm;" class="g-recaptcha" onclick="updateCoordinator()"> Update Coordinator
                                    </button>
                                </div>
                            </form>
                        </div>

                        <!-- View All Coordinator Form -->
                        <div id="ViewAllCoordinator" style="width: 900px;border-radius:1%;" class="a_message2" hidden>
                            <h2 style="text-align:center;" class="a_message_title">View All Coordinator</h2>
